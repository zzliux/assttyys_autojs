    ...
    },
    {
        ...
        data: [{
            judgePoints: [
                ...
                { x: 1081, y:  140, c: 0x583716, i: true },
                { x:  969, y:  146, c: 0xf8f3e0, i: true },
                { x: 1571, y:   38, c: 0x322425, i: true },// 0/30中0左面的几个点
                { x: 1569, y:   49, c: 0x322425, i: true },
                { x: 1571, y:   49, c: 0x322425, i: true },
                { x: 1576, y:   43, c: 0x322425, i: true },
                { x: 1577, y:   55, c: 0x322425, i: true },
                { x: 1571, y:   62, c: 0x322425, i: true },
                { x: 1584, y:   50, c: 0xf6f1de, i: true }, // 0/30中0上面的几个点
                { x: 1590, y:   50, c: 0x2f2423, i: true },
                { x: 1592, y:   44, c: 0x312324, i: true },
                { x: 1598, y:   50, c: 0xe3decd, i: true },
            ],
            operaPoints: []
        }]
    }
