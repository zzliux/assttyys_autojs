export default [
  ...
  {
    question: '阿修罗攻击目标并造成击杀时会对目标附加以下哪种印记',
    ans: '诛灭',
  },
  ...
  {
    question: '白狼进入冥想状态后下次行动会增加自身的哪一种属性',
    ans: '暴击伤害',
  },
  ...
  {
    question: '帮助几位后辈完成独当一面任务后可以获得誉满京都头像框',
    ans: '5',
  },
  {
    question: '被椒图的技能涓流链接的式神每次行动后恢复椒图百分之多少的生命值',
    ans: '5%',
  },
  ...
  {
    question: '不携带任何御魂的辉夜姬普攻会概率触发什么效果',
    ans: '削减敌方目标鬼火',
  },
  {
    question: '不携带任何御魂的狸猫能附加哪种控制效果',
    ans: '挑衅|桃鲜|挑鲜|桃衅',
  },
  ...
  {
    question: '不在同一个阴阳寮的好友间满足什么条件才可以赠送SSR碎片',
    ans: '亲友关系达到永远的羁绊',
  },
  { question: '不知火星火结界存在回合数是', ans: '2' },
  {
    question: '不知火星火结界下的额外普攻以下哪种描述是正确的',
    ans: '其余选项皆对',
  },
  ...
  {
    question: '赤影妖刀姬的穷追不舍技能会对敌方哪个目标附加锁定',
    ans: '生命比例最低',
  },
  {
    question: '赤影妖刀姬使用满级赤影一瞬击杀非召唤物敌人会产生哪',
    ans: '获得新回合',
  },
  {
    question: '宠物后院中通过宠物食粮吸引来已变成宠物的小动物会奖励什么',
    ans: '萌爪钱币',
  },
  ...
  {
    question: '传记中彼岸花呱在阎魔呱偷偷归还衣服的时候为她准备了什么',
    ans: '伤损药膏',
  },
  ...
  {
    question: '传记中青行灯呱为了模仿青行灯脑洞了哪些故事',
    ans: '其余选项皆对',
  },
  {
    question: '传记中青行灯呱在给辉夜姬呱说起怪谈故事的时候会发生什么',
    ans: '自己先睡着了',
  },
  ...
  {
    question: '大江山轶闻以下哪一种金属不包括在洗练源氏兵器需要的材料中',
    ans: '生铁',
  },
  { question: '大江山轶闻以下哪一种可以作为海族的通讯媒介', ans: '妖浪' },
  {
    question: '大江山轶闻以下哪种结界可以净化鬼族的瘴气',
    ans: '黄泉之境的结界',
  },
  { question: '大江山轶闻以下谁的力量最终激活了云外镜', ans: '山岳神' },
  {
    question: '大江山轶闻阴阳师大人可以在哪里为出战式神配己置武器',
    ans: '源氏藏兵阁',
  },
  {
    question: '大江山轶闻源赖光无法逃避无力改变的东西是',
    ans: '狐火降临京都的夜晚',
  },
  { question: '大江山轶闻在鬼王座茨木童子和鬼切中了谁的幻术', ans: '海鸣' },
  {
    question: '大江山轶闻在酒吞童子邀请源氏结盟时源赖光称呼酒吞童子什么',
    ans: '昔日的鬼王',
  },
  { question: '大江山轶闻战胜鬼域最高峰的石巨人的是谁', ans: '酒吞童子' },
  { question: '大天狗呱的扇子写着什么字', ans: '呱' },
  {
    question: '大岳丸施放的无尽剑狱会在什么时机关闭',
    ans: '大岳丸的下一回合结束',
  },
  {
    question: '待宵姑获鸟每3次普攻下1次普攻会替换成以下哪个技能',
    ans: '墨影剑光',
  },
  { question: '单人挑战巫女大蛇悲鸣时需要消耗多少体力', ans: '12点' },
  { question: '单人挑战御魂或觉醒副本的一到十层需要消耗多少体力', ans: '6点' },
  {
    question: '当浮世青行灯收集多少鬼火后可以获得额外技能浮世终话',
    ans: '100',
  },
  ...
  {
    question: '敌方被百目鬼附加凝视状态后主动技能会被替换为以下哪个技能',
    ans: '邪光',
  },
  { question: '独眼小僧背着的石僧是他的', ans: '师父' },
  { question: '独眼小僧是化成的妖怪', ans: '木鱼' },
  {
    question: '对于鬼童丸附加骸之锁的目标以下哪种说法是正确的',
    ans: '无法受到改变行动条的效果',
  },
  ...
  {
    question: '河童在游戏与现世中都有着类似的形象它的身体特征是',
    ans: '其余选项皆对',
  },
  ...
  {
    question: '化鲸的齿甲触发的真实伤害上限与携带者的哪个属性有关',
    ans: '攻击',
  },
  {
    question: '化鲸的体甲的携带者在行动前治疗生命与化鲸的哪个属性有关',
    ans: '生命上限',
  },
  { question: '荒川中最强大的妖怪是', ans: '荒川之主' },
  {
    question: '荒的技能星辰之境所触发的幻境附带以下哪一个效果',
    ans: '荒的协战',
  },
  ...
  {
    question: '辉夜姬的技能龙首之玉所触发的幻境没有以下哪一个效果',
    ans: '生命值增加',
  },
  ...
  {
    question: '惠比寿的技能鲤鱼旗鲤鱼旗最多继承惠比寿百分之多少生命',
    ans: '60',
  },
  {
    question: '获得结界皮肤编心织忆后可以获得以下哪种加成',
    ans: '结界卡经验加成',
  },
  { question: '获得头像框月见黑需要连续多少次召唤不出SSR', ans: '400' },
  {
    question: '获取结界皮肤折梦祈月后结界突破可以获得以下哪种加成',
    ans: '效果抵抗加成',
  },
  ...
  {
    question: '介绍了诸多式神之间羁绊的泡面番阴阳师平安物语其片尾曲叫做',
    ans: '起风了',
  },
  ...
  {
    question: '剧情中没有伴随晴明释放阴阳分离之术而失忆的式神是',
    ans: '其余选项皆对',
  },
  ...
  {
    question: '面具的细节不同象征着的妖怪也不同红脸高鼻式的面具是属于谁的',
    ans: '大天狗',
  },
  ...
  {
    question: '哪个呱太在出门前总要检查口脂有没有涂得完美对称',
    ans: '彼岸花呱',
  },
  ...
  {
    question: '平安百物语中茨木呱的手里为什么一直拿着气球',
    ans: '气球是他的力量',
  },
  ...
  {
    question: '平安百物语中金鱼姬征服世界道路上第一个想要打败的人是',
    ans: '荒',
  },
  {
    question: '平安百物语中酒吞童子第一次见到酒吞呱时感受如何',
    ans: '觉得可爱',
  },
  { question: '平安百物语中谁梦想成为京都的明星', ans: '蝴蝶精' },
  {
    question: '器物经百年得化为精灵诓骗人心例如唐纸伞妖人们称之为',
    ans: '付丧神',
  },
  ...
  {
    question: '青行灯的技能吸魂灯每次对一名敌方最多可能吸取几点鬼火',
    ans: '1',
  },
  ...
  {
    question: '若樱花妖自身未处于无法动作以下哪个时机樱花妖会治疗友方',
    ans: '其他友方回合结束时',
  },
  {
    question: '刹那莲华绽放恢复友方生命总量与帝释天的哪个属性有关',
    ans: '攻击',
  },
  ...
  {
    question: '升级式神需要消耗的道具或材料不包含以下哪一个',
    ans: '神秘的符咒',
  },
  ...
  {
    question: '庭院中地藏像前有使用七曜记日的木牌关于七曜日其正确的排序是',
    ans: '日月火水木金土',
  },
  ...
  {
    question: '童男曾被委任调查三大神器之一的下落以下不是三大神器的是',
    ans: '天羽羽斩',
  },
  ...
  {
    question: '现世中狐狸被视为主管丰产的稻荷神的使者被称作稻荷神的式神是',
    ans: '御馔津',
  },
  {
    question: '现世中立春前一天被称为节分人们为了驱邪纳福会',
    ans: '其余选项皆对',
  },
  { question: '现世中犬神的种类属于', ans: '柴犬' },
  {
    question: '想要回顾已经解锁的主线剧情入口是',
    ans: '点击庭院大树-前尘忆梦',
  },
  ...
  {
    question: '以下式神中稀有度最低的是',
    ans: '星熊童子|星能童千|星能童子|星熊童千',
  },
  ...
  {
    question: '以下式神中有兄弟或姐妹是谁',
    ans: '鬼使黑|鬼使白|跳跳弟弟|跳跳哥哥|洗洗哥哥|跳跳妹妹|童男|童女',
  },
  ...
  {
    question: '阴阳寮采办的经验加成每次战斗胜利可以额外提升多少经验奖励',
    ans: '0.1',
  },
  ...
  {
    question: '游戏剧情中喜欢帮助弱者盗取田中之水狮鼻通体赤红的妖怪是',
    ans: '赤舌',
  },
  {
    question: '游戏内常出现的鲤鱼旗因崇鲤文化而生现世中鲤鱼是的象征',
    ans: '其余选项皆对',
  },
  {
    question: '游戏中使用寿司来代表阴阳师的体力这种寿司的种类是',
    ans: '军舰卷',
  },
  { question: '游戏中天邪鬼一共有几种', ans: '4种' },
  {
    question: '游戏中许多式神都有着对应的同人歌曲创作黑风凯歌是属于谁的',
    ans: '大天狗',
  },
  {
    question: '游戏中诸多元素都与鲤鱼旗有关现世中它们是节日的象征',
    ans: '男孩节',
  },
  ...
  {
    question: '御怨般若开启封印结界非怪物敌方会受到以下哪种效果',
    ans: '其余选项皆对',
  },
  ...
  {
    question: '在大岳丸放逐敌方目标过程中普攻增加以下哪种效果',
    ans: '其余选项皆对',
  },
  ...
  {
    question: '鬼灭之刃题目初次见到灶门祢豆子时我妻善逸怎样看待祢豆子的',
    ans: '好可爱',
  },
  ...
  {
    question: '鬼灭之刃题目鬼灭中梦魇如何避免强制昏睡进入梦境',
    ans: '避免对视',
  },
  ...
  {
    question: '鬼灭之刃题目炼狱槙寿郎初见炭治郞郎说自己使用呼吸是',
    ans: '日之呼吸',
  },
  { question: '鬼灭之刃题目炼狱杏寿郎的精神内核是颜色', ans: '红色' },
  {
    question: '鬼灭之刃题目炼狱杏寿郎告诉父亲自己成为炎柱之后父亲的回答是',
    ans: '无聊无谓',
  },
  ...
  {
    question: '鬼灭之刃题目千寿郎将什么作为兄长遗物送给了炭治郎',
    ans: '刀锷|刀锅',
  },
  ...
  {
    question: '鬼灭之刃题目炭治郎额头的印记最初是怎么形成的',
    ans: '被火盆烫伤',
  },
  ...
  {
    question: '鬼灭之刃题目灶门祢豆子木箱的原材料雾云杉拥有何种特征',
    ans: '非常轻',
  },
  { question: '鬼灭之刃题目灶门祢豆子通过哪种方式恢复体力', ans: '睡觉' },
  { question: '鬼灭之刃题目灶门祢豆子咬的竹筒是谁让她咬着的', ans: '富冈义勇' },
  {
    question: '鬼灭之刃题目灶门炭治郎额头的伤疤是为了保护谁留下的',
    ans: '弟弟',
  },
  {
    question: '鬼灭之刃题目灶门炭治郎无法面不改色做的事情是',
    ans: '撒谎|批荒|撒荒|批谎|报诺',
  },
  {
    question:
      '鬼灭之刃题目灶门炭治郎遇到鬼舞辻无惨时对方抱着的小孩对无惨的称呼是',
    ans: '爸爸',
  },
  ...
  {
    question: '鬼灭之刃题目嘴平伊之助第一次摘掉头套时我妻善逸的反应是',
    ans: '长得像女生一样',
  },
  ...
  {
    question: '鬼灭之刃题目最终选拔的合格条件是在藤袭山中存活几天',
    ans: '七天',
  },
  ...
  {
    question: '一般钢琴是以一连串八度音程区间所构成请问同一音程中有几个黑阶',
    ans: '五个',
  },
  { question: '两面佛攻击时风神对敌方会造成以下哪种效果', ans: '造成间接伤害' },
  { question: '以下哪个技能可以为友方全体获得护盾', ans: '风神之佑' },
  {
    question: '以下式神中不携带任何御魂的情况下谁的技能能造成间接伤害',
    ans: '山风',
  },
  { question: '六弦琴是乐器的别称', ans: '吉他' },
  {
    question: '夏季在烈日下工作或运动量过大出汗多时为预防中暑应多喝',
    ans: '盐开水',
  },
  ...
  {
    question: '绿色蔬菜营养丰富下列不属于绿色蔬菜所含营养物质的为',
    ans: '蛋白质',
  },
  ...
  {
    question: '当夜汉彼岸花处于沉眠状态中会有以下哪种效果',
    ans: '其余选项皆对',
  },
  ...
  { quesiton: '9级的经验酒壶每次可以存储多少溢出经验', ans: '80000' },
  { quesiton: '9级的体力食盒每次可以存储多少溢出经验', ans: '250' },
  { quesiton: 'SP阶式神返魂可以获得多少御札', ans: '750' },
  { quesiton: 'SP阶式神可以通过多少个对应的式神碎片召唤获得', ans: '60' },
  { quesiton: 'SSR阶式神可以通过多少个对应的式神碎片召唤获得', ans: '50' },
  { quesiton: "阿修罗'理性'印记的获得上限是", ans: '9' },
  {
    quesiton: "帮助几位后辈完成'独当一面'任务后可以获得誉满京都头像框",
    ans: '5',
  },
  { quesiton: '不携带任何御魂的麓铭大岳丸能附加哪种控制效果', ans: '眩晕' },
  { quesiton: '不携带任何御魂的御馔津不能附加哪种效果', ans: '变形' },
  { quesiton: "蝉冰雪女施放'永冬'技能会给目标附加以下哪种状态", ans: '霜冻' },
  { quesiton: '成就点达到多少才可以指导后辈', ans: '2500' },
  {
    quesiton: "赤影妖刀姬的'穷追不舍'技能会对敌方哪个目标附加'锁定'印记",
    ans: '生命比例最低',
  },
  { quesiton: '筹备阴阳寮宴会料理需要消耗以下哪种材料', ans: '阴阳寮勋章' },
  { quesiton: '传记中谁与入殓师和一反木绵建立了深厚的情谊', ans: '织雪' },
  {
    quesiton: "当夜溟彼岸花处于'沉眠'状态中会有以下哪种效果",
    ans: '其余选项皆对',
  },
  {
    quesiton: "队友每回合首次普攻拥有'羽授'的待宵姑获乌会触发哪种效果",
    ans: '协战',
  },
  { quesiton: '多少个中级觉醒材料可以合成一个高级觉醒材料', ans: '8' },
  { quesiton: "风姿度达到多少可以解锁'风姿·銮华扇'", ans: '8000' },
  { quesiton: "风姿度达到多少可以解锁'风姿·神霖羽'", ans: '12000' },
  { quesiton: '缚骨清姬的蛇灵会对带有哪种状态的目标进行攻击', ans: '怨' },
  { quesiton: '好友结界寄养时长为', ans: '6小时' },
  { quesiton: '会长离线时间超过几天阴阳寮成员可以选择罢免会长', ans: '7' },
  { quesiton: '绘卷中歌姬不知火在哪里长大成人', ans: '离岛' },
  { quesiton: '绘卷中鬼童丸曾经的老师是', ans: '贺茂忠行' },
  { quesiton: "绘卷中教导铃鹿御前理解'义理'的力量的是", ans: '田村' },
  { quesiton: '绘卷中谁是守护永生之海的鲛人公主', ans: '千姬' },
  { quesiton: '绘卷中谁为战争而流离失所的人和妖提供了庇护', ans: '姑获鸟' },
  { quesiton: '绘卷中寻找大妖的贺茂义心称不知火为', ans: '阿离' },
  { quesiton: '绘卷中与缚骨清姬爱恨纠缠的男子是', ans: '安珍' },
  {
    quesiton: "获得结界皮肤'编心织忆'后可以获得以下哪种加成",
    ans: '结界卡经验加成',
  },
  {
    quesiton: "获取结界皮肤'折梦祈月'后结界突破可以获得以下哪种加成",
    ans: '效果抵抗加成',
  },
  { quesiton: '紧那罗共能弹奏几种律音', ans: '5' },
  { quesiton: '剧情中八岐大蛇与谁缔结契约', ans: '源赖光' },
  {
    quesiton: '两面佛攻击时风神对敌方会造成以下哪种效果',
    ans: '造成间接伤害',
  },
  {
    quesiton: "铃鹿御前的'麓魂·极'获得的护盾与自身的哪个属性有关",
    ans: '攻击',
  },
  { quesiton: "聆海金鱼姬获得'凝神'印记的层数上限是", ans: '8' },
  { quesiton: '每日的前多少次阴阳寮任务可以获得双倍奖励', ans: '10' },
  { quesiton: '每周可以挑战多少次真·八岐大蛇副本并获得奖励', ans: '2' },
  {
    quesiton: '每周最多可以使用八岐大蛇鳞片兑换多少个朴素的御魂礼盒',
    ans: '30',
  },
  { quesiton: '面灵气的恶面能为自身提供以下哪种效果', ans: '速度' },
  { quesiton: '面灵气的善面不能为友方提供以下哪种效果', ans: '速度' },
  { quesiton: "千姬的'海原贝戟'继承千姬百分之几的防御", ans: '100%' },
  { quesiton: '千姬的海原贝戟生命值与千姬的哪个属性有关', ans: '攻击' },
  { quesiton: '商店寄售屋可以进行的操作是', ans: '其余选项皆对' },
  { quesiton: '商店杂货铺每周购买御灵境之钥的上限为', ans: '40' },
  { quesiton: '声望达到多少可以每日挑战2只不同的地域鬼王', ans: '2000' },
  { quesiton: '声望达到多少可以每日挑战3只不同的地域鬼王', ans: '10000' },
  { quesiton: '守护历练每天可挑战多少次', ans: '5' },
  { quesiton: '挑战日轮之陨可以获得几种不同种类的御魂', ans: '4' },
  { quesiton: "通过'暴食鬼'能做到的是", ans: '升级式神' },
  { quesiton: '头像框-大阴阳师的获得方式是', ans: '为崽而战捌段前一百' },
  { quesiton: '头像框-凤凰火的获得方式是', ans: '人气达到10000' },
  { quesiton: '头像框-花柒语的获得方式是', ans: '签到777天' },
  { quesiton: '头像框-京都名士的获得方式是', ans: '为崽而战捌段前五百' },
  { quesiton: '头像框-久相伴的获得方式是', ans: '签到999天' },
  { quesiton: '头像框-玲珑锦簇的获得方式是', ans: '签到1234天' },
  { quesiton: '头像框-千眷依的获得方式是', ans: '签到1500天' },
  { quesiton: '头像框-相依偎的获得方式是', ans: '签到500天' },
  { quesiton: '协同斗技选择式神阶段玩家可以选择几位式神', ans: '3' },
  { quesiton: '以下材料或道具哪种不能通过花合战获得', ans: '御魂' },
  { quesiton: '以下材料或道具哪种不能在结界突破中获得', ans: '御行达摩' },
  { quesiton: '以下材料或道具哪种不能在秘闻副本中获得', ans: '插画券' },
  {
    quesiton: "以下宠物中哪一个可以通过参与公益活动'守护的契约'获得",
    ans: '赤雪犬',
  },
  { quesiton: '以下宠物中喂养哪一个可以获得御魂加成', ans: '三花猫' },
  { quesiton: '以下幻境或结界中哪一个能由帝释天开启', ans: '王之盛宴' },
  { quesiton: '以下哪个不是阿修罗的技能', ans: '炼狱之门' },
  { quesiton: '以下哪个不是帝释天的技能', ans: '苦海浮生' },
  { quesiton: '以下哪个不是星熊童子的技能', ans: '海潮入梦' },
  { quesiton: '以下哪个技能是群体伤害技能', ans: '堕天' },
  { quesiton: '以下哪款APP每日签到能获得专属头像框', ans: '大神APP' },
  { quesiton: '以下哪种道具无法通过式神委派获得', ans: '式神挑战券' },
  { quesiton: '以下哪种方法可以获得逢魔之魂', ans: '其余选项皆对' },
  { quesiton: '以下哪种方式不能获得增加式神亲密度的道具', ans: '御灵副本' },
  { quesiton: '以下哪种能力是不知火的星火结界拥有的', ans: '其余选项皆对' },
  { quesiton: '以下皮肤中哪款不属于不知火', ans: '浮梦花烛' },
  { quesiton: '以下皮肤中哪款不属于姑获鸟', ans: '素月浅香' },
  { quesiton: '以下皮肤中哪款不属于鬼切', ans: '琥珀龙魂' },
  { quesiton: '以下皮肤中哪款不属于辉夜姬', ans: '风铃彩' },
  { quesiton: '以下皮肤中哪款不属于妖刀姬', ans: '冬岚之刃' },
  { quesiton: '以下皮肤中哪款不属于缘结神', ans: '福禄金尊' },
  { quesiton: '以下式神中哪一个不能开启幻境', ans: '紧那罗' },
  { quesiton: '以下式神中哪一个能为友方提供护盾', ans: '其余选项皆对' },
  { quesiton: '以下式神中哪一个无法通过受到治疗恢复生命', ans: '云外镜' },
  { quesiton: '以下式神中能保护友方的技能是', ans: '方圆之备' },
  { quesiton: '以下式神中谁被称为铃鹿山的少主', ans: '大岳丸' },
  { quesiton: '以下式神中谁被贺茂家流放至修罗鬼道', ans: '鬼童丸' },
  { quesiton: '以下式神中谁不能使友方式神恢复血量', ans: '缚骨清姬' },
  { quesiton: '以下式神中谁不能为敌方附加孤立', ans: '天剑韧心鬼切' },
  { quesiton: '以下式神中谁不属于铃鹿山', ans: '泷夜叉姬' },
  { quesiton: '以下式神中谁曾为迷惑鬼切化身美女', ans: '茨木童子' },
  { quesiton: '以下式神中谁的技能不能使敌方中毒', ans: '猫掌柜' },
  { quesiton: '以下式神中谁的技能能为友方式神提升效果抵抗', ans: '白童子' },
  { quesiton: '以下式神中谁的武器是手里剑', ans: '风狸' },
  { quesiton: '以下式神中谁将铃鹿山的各项事物交予大岳丸', ans: '铃鹿御前' },
  { quesiton: '以下式神中谁讲述了入殓师和一反木绵的故事', ans: '天井下' },
  { quesiton: '以下式神中谁可以帮助友方式神抵挡控制效果', ans: '花鸟卷' },
  { quesiton: '以下式神中谁能操纵敌方式神', ans: '帝释天' },
  { quesiton: '以下召唤物中谁具有最高的召唤优先级', ans: '缚骨清姬的蛇灵' },
  { quesiton: '阴阳师等级达到多少级百鬼夜行中才会出现SP阶式神', ans: '60' },
  { quesiton: '永久勾玉卡多少小时可以领取一次5勾玉', ans: '6' },
  { quesiton: "御魂'贝吹坊'的四件套可能触发的效果是", ans: '抵挡伤害' },
  { quesiton: "御魂'兵主部'的两件套可能触发的效果是", ans: '攻击加成' },
  { quesiton: "御魂'海月火玉'的四件套可能触发的效果是", ans: '伤害提升' },
  { quesiton: "御魂'青女房'的两件套可能触发的效果是", ans: '暴击加成' },
  { quesiton: "御魂'涂佛'的两件套可能触发的效果是", ans: '生命加成' },
  { quesiton: "御怨般若施放'积重难返'技能需要消耗几层'仇恨印记'", ans: '9' },
  { quesiton: '缘结神共能赐予友方式神几种缘结', ans: '4' },
  {
    quesiton: '云外镜阳状态下昙无造成的伤害与自身的哪个属性有关',
    ans: '防御',
  },
  { quesiton: '周六至周日每日前多少次挑战日轮之陨可获得奖励加成', ans: '50' },
];
