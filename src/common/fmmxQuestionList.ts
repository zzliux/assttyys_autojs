export default [
	...
	{ question: '烟花中使用的延迟剂通常是什么', '石蜡' },
	{ question: '烟花设计中哪种技术用于产生旋转效果', '使用离心力' },
	{ question: '烟花大会中哪种安全措施是必须遵守的', '保持安全距离' },
	{ question: '游园会上哪种表演通常在晚上举行', '烟火表演' },
	{ question: '烟花设计中哪种技术用于产生瀑布效果', '使用长条火药' },
	{ question: '烟花大会通常在哪个季节举行', '夏季' },
	{ question: '烟火大会中哪种情况下应该遵守安全指示', '任何时候' },
	{ question: '烟火大会中哪种情况下应该立即撤离', '烟火表演中出现异常' },
	{ question: '烟火大会中使用的烟火是有什么制成的', '火药' },
	{ question: '集齐全部呱太可获得什么', '随机SSR式神' },
];
