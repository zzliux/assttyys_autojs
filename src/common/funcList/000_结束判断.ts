...
export class Func000 implements IFuncOrigin {
	...
	// 	const a = _thisConfigOperator.get(0, 'jspd_enabled_zjsj');
	// 	const b = _thisConfigOperator.get(0, 'jspd_times_zjsj');
	// 	_thisConfigOperator.set(0, 'jspd_enabled_zjsj', false);
	// 	_thisConfigOperator.set(0, 'jspd_times_zjsj', 30);
