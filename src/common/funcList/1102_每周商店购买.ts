...
export class Func1102 implements IFuncOrigin {
	...
	operator: IFuncOperatorOrigin[] = [{ // 0 庭院_商店
		...
		desc: [
			1280, 720,
			[
				[center, 872, 424, 0xf88a3d],
				[center, 958, 427, 0xff882b],
				[center, 909, 397, 0xff8638],
				[center, 931, 442, 0x272424],
				[center, 893, 475, 0x545150],
			]
		],
		oper: [
			[center, 1280, 720, 881, 411, 953, 478, 1000],
		]
	}, { // 36 杂货铺_魅力内
		desc: [
			1280, 720,
