...
export default {
    ...
    '悬赏_击败字样': {
        // 由于击败两个字比较小很容易出现找色失败所以取了多个
        region: [left, 1280, 720, 125, 401, 1170, 601],
        desc: [
            [1280, 720,
                [
                    [left, 228, 431, 0x2f2b26],
                    [left, 236, 439, 0x2c2824],
                    [left, 259, 447, 0x332e29],
                    [left, 237, 439, 0x35302b],
                    [left, 248, 442, 0x484039],
                    [left, 243, 447, 0x3e3831],
                    [left, 158, 566, 0x97806e]

                ]
            ],
            [1280, 720,
                [
                    [center, 942, 431, 0x2f2b26],
                    [center, 954, 448, 0x514840],
                    [right, 973, 448, 0x464038],
                    [right, 969, 437, 0x36312c],
                    [right, 967, 431, 0x4c433c],
                    [center, 946, 439, 0x302b27],
                    [center, 959, 437, 0x302c27],
                    [left, 158, 566, 0x97806e]
                ]
            ],
            [1280, 720,
                [
                    [left, 264, 413, 0x34302b],
                    [left, 268, 408, 0x504740],
                    [left, 273, 424, 0x342f2a],
                    [left, 283, 411, 0x564d44],
                    [left, 293, 409, 0x37322c],
                    [left, 299, 425, 0x443d37],
                    [left, 158, 566, 0x97806e]
                ]
            ],
            [1280, 720,
                [
                    [left, 260, 463, 0x554d42],
                    [left, 276, 461, 0x4a423b],
                    [left, 268, 469, 0x38322d],
                    [left, 268, 454, 0x322d28],
                    [left, 293, 454, 0x37322c],
                    [left, 282, 470, 0x49413a],
                    [left, 297, 459, 0x4a433a],
                    [left, 299, 470, 0x413b33],
                    [left, 158, 566, 0x97806e]
                ]
            ],
            [1280, 720,
                [
                    [center, 517, 433, 0x453e37],
                    [center, 517, 446, 0x423b35],
                    [center, 513, 440, 0x332e29],
                    [center, 525, 439, 0x2c2824],
                    [center, 520, 435, 0x584e46],
                    [center, 534, 437, 0x38332d],
                    [center, 533, 446, 0x706257],
                    [center, 543, 445, 0x544b42],
                    [center, 543, 436, 0x88776a],
                    [left, 158, 566, 0x97806e]
                ]
            ],
            [1280, 720,
                [
                    [left, 217, 431, 0x2f2b26],
                    [left, 217, 447, 0x423b35],
                    [left, 223, 444, 0x36312b],
                    [left, 249, 448, 0x443c36],
                    [left, 246, 437, 0x5e544b],
                    [left, 242, 431, 0x5a4f47],
                    [left, 158, 566, 0x97806e]
                ]
            ],
            [1280, 720,
                [
                    [center, 500, 431, 0x2f2b26],
                    [center, 499, 447, 0x403a33],
                    [center, 505, 447, 0x35302b],
                    [center, 506, 444, 0x322d28],
                    [center, 509, 439, 0x464038],
                    [center, 525, 431, 0x4a423b],
                    [center, 522, 447, 0x5e534b],
                    [center, 529, 437, 0x62574e],
                    [left, 158, 566, 0x97806e]
                ]
            ],
            [1280, 720,
                [
                    [left, 245, 409, 0x36312b],
                    [left, 250, 412, 0x38332e],
                    [left, 241, 413, 0x453d37],
                    [left, 237, 418, 0x5d524a],
                    [left, 253, 416, 0x49423b],
                    [left, 251, 421, 0x36312c],
                    [left, 240, 425, 0x3a352f],
                    [left, 158, 566, 0x97806e]
                ]
            ],
            [1280, 720,
                [
                    [left, 212, 431, 0x36312b],
                    [left, 212, 440, 0x38322d],
                    [left, 220, 439, 0x322d28],
                    [left, 207, 440, 0x39332e],
                    [left, 206, 447, 0x3d3731],
                    [left, 217, 447, 0x49413a],
                    [left, 229, 439, 0x3a342f],
                    [left, 239, 437, 0x36312c],
                    [left, 237, 443, 0x3a342f],
                    [left, 242, 447, 0x322e28],
                    [left, 158, 566, 0x97806e]
                ]
            ]
        ]
    ...
    '悬赏_副本关闭按钮': {
        region: [left, 1280, 720, 815, 21, 1276, 340],
        desc: [
            [1280, 720,
                [
                    [right, 1189, 98, 0xa4617d],
                    [right, 1168, 106, 0xfbc2ca],
                    [right, 1188, 110, 0xfedcdc],
                    [right, 1178, 118, 0xe8d4cf],
                    [right, 1167, 132, 0xc68687],
                    [right, 1193, 130, 0xc97f8f],
                    [right, 1205, 135, 0x935172],
                    [right, 1178, 147, 0x5b3034]
                ]
            ],
            [1280, 720,
                [
                    [right, 1193, 102, 0x792b4d],
                    [right, 1184, 111, 0xdba5a7],
                    [right, 1163, 131, 0x8b3647],
                    [right, 1160, 105, 0x834a52],
                    [right, 1178, 117, 0xe8d5cf],
                    [right, 1205, 135, 0x935172],
                    [right, 1188, 98, 0xa3617a],
                    [right, 1203, 107, 0x692a48],
                    [right, 1158, 119, 0x6f3335]
                ]
            ],
            [1280, 720,
                [
                    [right, 1055, 127, 0x582036],
                    [right, 1065, 129, 0x713f50],
                    [right, 1028, 138, 0x9d6b6c],
                    [right, 1046, 150, 0xebdac9],
                    [right, 1073, 167, 0x834662],
                    [right, 1065, 171, 0x5a3131],
                    [right, 1051, 168, 0x6c2f3a],
                    [right, 1023, 152, 0x662c2c],
                    [right, 1030, 152, 0x884f57]
                ]
            ],
            [1280, 720,
                [
                    [right, 1039, 126, 0x9f4d56],
                    [right, 1063, 122, 0xa05d7f],
                    [right, 1067, 133, 0xe9c7c7],
                    [right, 1079, 159, 0x904d6f],
                    [right, 1042, 153, 0xd48989],
                    [right, 1070, 154, 0xe37d9f],
                    [right, 1075, 129, 0x5c243b],
                    [right, 1037, 145, 0x895058]
                ]
            ]
        ]
    },
